...
namespace CondominioADM.Migrations
{
    ...
    [Migration("20211203160246_Modificando Entidades de Arrienda")]
    partial class ModificandoEntidadesdeArrienda
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CondominioADM.Entidades.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fecha = new DateTime(2021, 12, 3, 12, 2, 44, 453, DateTimeKind.Local).AddTicks(1577),
                            Nombres = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("CondominioADM.Entidades.DepositoApartamento", b =>
                {
                    b.HasOne("CondominioADM.Entidades.ArriendaApartamentos", "ArriendaApartamento")
                        .WithMany()
                        .HasForeignKey("ArriendaApartamentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ArriendaApartamento");
                });

            modelBuilder.Entity("CondominioADM.Entidades.DepositoParqueo", b =>
                {
                    b.HasOne("CondominioADM.Entidades.ArriendaParqueos", "ArriendaParqueo")
                        .WithMany()
                        .HasForeignKey("ArriendaParqueosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ArriendaParqueo");
                });
