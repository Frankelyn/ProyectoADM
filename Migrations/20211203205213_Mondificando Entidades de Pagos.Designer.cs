...
namespace CondominioADM.Migrations
{
    ...
    [Migration("20211203205213_Mondificando Entidades de Pagos")]
    partial class MondificandoEntidadesdePagos
    {
            ...
            modelBuilder.Entity("CondominioADM.Entidades.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fecha = new DateTime(2021, 12, 3, 16, 52, 11, 145, DateTimeKind.Local).AddTicks(7397),
                            Nombres = "Admin"
                        });
                });
