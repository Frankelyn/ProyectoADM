...
namespace CondominioADM.Migrations
{
    ...
    [Migration("20211203201730_Modificando entidades Residente y pagos")]
    partial class ModificandoentidadesResidenteypagos
    {
            ...
            modelBuilder.Entity("CondominioADM.Entidades.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fecha = new DateTime(2021, 12, 3, 16, 17, 28, 631, DateTimeKind.Local).AddTicks(1878),
                            Nombres = "Admin"
                        });
                });
